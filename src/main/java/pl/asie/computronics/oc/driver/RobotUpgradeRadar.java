...
public class RobotUpgradeRadar extends ManagedEnvironment implements DeviceInfo {
	...
	private AxisAlignedBB getBounds(int d) {
		...
		return AxisAlignedBB.
			fromBounds(container.xPosition() - 0.5, container.yPosition() - 0.5, container.zPosition() - 0.5, container.xPosition() + 0.5, container.yPosition() + 0.5, container.zPosition() + 0.5).
