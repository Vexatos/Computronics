...
public class DeepStorageUnitPeripheral extends CCTilePeripheral<IDeepStorageUnit> {

	public DeepStorageUnitPeripheral() {
	}

	public DeepStorageUnitPeripheral(IDeepStorageUnit dsu, World world, int x, int y, int z) {
		super(dsu, "dsu", world, x, y, z);
	}
