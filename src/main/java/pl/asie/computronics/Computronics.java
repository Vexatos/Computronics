...
@Mod(modid = Mods.Computronics, name = Mods.Computronics_NAME, version = "1.1.0", useMetadata = true, dependencies = "required-after:asielib;after:ComputerCraft;after:OpenComputers;after:OpenComputers|Core;after:MineFactoryReloaded;after:RedLogic;after:ProjRed|Core;after:nedocomputers;after:Railcraft;after:gregtech")
