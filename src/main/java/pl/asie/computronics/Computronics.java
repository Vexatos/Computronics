...
@Mod(modid="computronics", name="Computronics", version="0.6.2", dependencies="required-after:asielib;after:ComputerCraft;after:OpenComputers;after:OpenComputers|Core")
