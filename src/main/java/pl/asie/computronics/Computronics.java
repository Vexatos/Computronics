...
@Mod(modid = Mods.Computronics, name = Mods.Computronics_NAME, version = "@VERSION@",
	dependencies = "required-after:asielib;required-after:Forge@[11.15.1.1722,);"
		+ "after:ComputerCraft@[1.78,);after:OpenComputers@[1.5.22.6,);after:tis3d@[0.8.3.13,);"
...
public class Computronics {
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		// Mod compat - GregTech
		/*if(itemTape != null && Mods.isLoaded(Mods.GregTech) && itemPartsGreg != null) { TODO GregTech
