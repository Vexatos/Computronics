...
public class GT_Recipe {
	...
	public static class GT_Recipe_Map {
		...
		public static final GT_Recipe_Map sMixerRecipes						= new GT_Recipe_Map						(new GT_ArrayList<GT_Recipe>(false,  100), "gt.recipe.mixer"						, "Mixer"							, null							, GregTech_API.GUI_PATH+"basicmachines/Mixer"						, 4, 1, ""					,    1, ""		, true						);
