...
public class GT_MetaTileEntity_BasicBatteryBuffer extends GT_MetaTileEntity_TieredMachineBlock {
	...
	public int mFilledSlotCount = mInventory.length;
	...
	@Override public long getMinimumStoredEU()						{return GregTech_API.VOLTAGES[mTier]*16*mInventory.length;}
	@Override public long maxEUStore()								{return GregTech_API.VOLTAGES[mTier]*64*mInventory.length;}
    @Override public long maxEUInput()								{return GregTech_API.VOLTAGES[mTier];}
    @Override public long maxEUOutput()								{return GregTech_API.VOLTAGES[mTier];}
    @Override public long maxAmperesIn()							{return mFilledSlotCount * 2;}
    @Override public long maxAmperesOut()							{return mFilledSlotCount;}
	...
	public void onPostTick(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
	    if (aBaseMetaTileEntity.isServerSide()) {
			...
			mFilledSlotCount = 0;
			for (ItemStack tStack : mInventory) if (GT_ModHandler.isElectricItem(tStack, mTier) && GT_ModHandler.isChargerItem(tStack)) mFilledSlotCount++;
	    }
	}
