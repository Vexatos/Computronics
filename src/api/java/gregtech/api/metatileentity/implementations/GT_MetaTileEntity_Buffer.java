...
public abstract class GT_MetaTileEntity_Buffer extends GT_MetaTileEntity_TieredMachineBlock {
	...
	@Override public long maxEUStore()								{return 512+GregTech_API.VOLTAGES[mTier]*50;}
    @Override public long maxEUInput()								{return GregTech_API.VOLTAGES[mTier];}
    @Override public long maxEUOutput()								{return bOutput?GregTech_API.VOLTAGES[mTier]:0;}
