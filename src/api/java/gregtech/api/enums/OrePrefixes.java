...
public enum OrePrefixes {
	...
	@Deprecated denseore	(""								, ""								, false, false, false, false, false,									-1),
	...
	fence					(""								, ""								, false, false, false, false, false,									-1), // Prefix used for Fences. Usually as "fenceWood". Introduced by Forge
	...
	stainedClay				(""								, ""								, false, false,  true, false, false,									-1), // Used for the 16 colors of Stained Clay. Introduced by Forge
	...
	static {
		...
		orePoor.mSecondaryMaterial = new MaterialStack(Materials.Stone, GregTech_API.MATERIAL_UNIT * 2);
	...
	public final ArrayList<OrePrefixes> mFamiliarPrefixes = new ArrayList<OrePrefixes>();
