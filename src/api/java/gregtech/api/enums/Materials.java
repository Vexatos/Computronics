...
public enum Materials implements IColorModulationContainer {
	...
	Gallium				(  37, Textures.SET_SHINY				,   1.0F,     64,  2, 1|2  |8                               , 220, 220, 255,   0,	"Gallium"						,    0,       0,          0,          0,          0,    0, false, false,   5,   1,   1, Dyes.dyeLightGray	, Element.Ga		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.ELECTRUM, 1))),
	...
	Niobium				(  47, Textures.SET_METALLIC			,   1.0F,      0,  2, 1|2  |8                               , 190, 180, 200,   0,	"Niobium"						,    0,       0,          0,          0,       2468, 2468,  true, false,   5,   1,   1, Dyes._NULL			, Element.Nb		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.ELECTRUM, 1))),
	...
	Neodymium			(  67, Textures.SET_METALLIC			,   7.0F,    512,  2, 1|2  |8      |64|128                  , 100, 100, 100,   0,	"Neodymium"						,    0,       0,          0,          0,       1297, 1297,  true, false,   4,   1,   1, Dyes._NULL			, Element.Nd		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MAGNETO, 2))),
	...
	Vanadium			(  29, Textures.SET_METALLIC			,   1.0F,      0,  2, 1|2  |8                               ,  50,  50,  50,   0,	"Vanadium"						,    0,       0,          0,          0,       2183, 2183,  true, false,   2,   1,   1, Dyes.dyeBlack		, Element.V			, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.RADIO, 1))),
	...
	Yttrium				(  45, Textures.SET_METALLIC			,   1.0F,      0,  2, 1|2  |8|16|32                         , 220, 250, 220,   0,	"Yttrium"						,    0,       0,          0,          0,       1799, 1799,  true, false,   4,   1,   1, Dyes._NULL			, Element.Y			, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.RADIO, 1))),
	...
	Rutile				(  -1, Textures.SET_NONE				,   1.0F,      0,  2, 1                                     , 255, 255, 255,   0,	"Rutile"						,    0,       0,          0,          0,          0,    0, false, false,   3,   1,   1, Dyes._NULL			), // TiO2
	...
	CrystalFlux			(  -1, Textures.SET_QUARTZ				,   1.0F,      0,  3, 1  |4                                 , 100,  50, 100,   0,	"Flux Crystal"					,    0,       0,          0,          0,          0,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Superconductor		(  -1, Textures.SET_NONE				,   1.0F,      0,  0, 0                                     , 255, 255, 255,   0,	"Superconductor"				,    0,       0,          0,          0,          0,    0, false, false,   1,   1,   1, Dyes.dyeLightGray	, Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 8))),
	...
	RareEarth			( 891, Textures.SET_FINE				,   1.0F,      0,  0, 1                                     , 128, 128, 100,   0,	"Rare Earth"					,    0,       0,          0,          0,          0,    0, false, false,   1,   1,   1, Dyes.dyeGray		, Arrays.asList(new TC_AspectStack(TC_Aspects.VITREUS, 1), new TC_AspectStack(TC_Aspects.LUCRUM, 1))),
	...
	AnnealedCopper		( 345, Textures.SET_SHINY				,   1.0F,      0,  2, 1|2             |128                  , 255, 120,  20,   0,	"Annealed Copper"				,    0,       0,          0,          0,          0,    0, false, false,   3,   1,   1, Dyes.dyeOrange		, 1, Arrays.asList(new MaterialStack(Copper, 1))),
	...
	NiobiumNitride		( 359, Textures.SET_DULL				,   1.0F,      0,  2, 1|2                                   ,  29,  41,  29,   0,	"Niobium Nitride"				,    0,       0,          0,          0,       2573, 2573,  true, false,   1,   1,   1, Dyes.dyeBlack		, 1, Arrays.asList(new MaterialStack(Niobium, 1), new MaterialStack(Nitrogen, 1))), // Anti-Reflective Material
	NiobiumTitanium		( 360, Textures.SET_DULL				,   1.0F,      0,  2, 1|2                                   ,  29,  29,  41,   0,	"Niobium-Titanium"				,    0,       0,          0,          0,       2800, 2800,  true, false,   1,   1,   1, Dyes.dyeBlack		, 1, Arrays.asList(new MaterialStack(Niobium, 1), new MaterialStack(Titanium, 1))),
	...
	VanadiumGallium		( 357, Textures.SET_SHINY				,   1.0F,      0,  2, 1|2                                   , 128, 128, 140,   0,	"Vanadium-Gallium"				,    0,       0,          0,          0,       3000, 3000,  true, false,   1,   1,   1, Dyes.dyeGray		, 1, Arrays.asList(new MaterialStack(Vanadium, 3), new MaterialStack(Gallium, 1))),
	...
	YttriumBariumCuprate( 358, Textures.SET_METALLIC			,   1.0F,      0,  2, 1|2                                   ,  80,  64,  70,   0,	"Yttrium Barium Cuprate"		,    0,       0,          0,          0,       1200, 1200,  true, false,   1,   1,   1, Dyes.dyeGray		, 1, Arrays.asList(new MaterialStack(Yttrium, 1), new MaterialStack(Barium, 2), new MaterialStack(Copper, 3), new MaterialStack(Oxygen, 7))),
	...
	IronMagnetic		( 354, Textures.SET_METALLIC			,   6.0F,    256,  2, 1|2          |64|128                  , 200, 200, 200,   0,	"Magnetic Iron"					,    0,       0,          0,          0,          0,    0, false, false,   4,  51,  50, Dyes.dyeGray		, 1, Arrays.asList(new MaterialStack(Iron, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MAGNETO, 1))),
	SteelMagnetic		( 355, Textures.SET_METALLIC			,   6.0F,    512,  2, 1|2          |64|128                  , 128, 128, 128,   0,	"Magnetic Steel"				,    0,       0,          0,          0,       1000, 1000,  true, false,   4,  51,  50, Dyes.dyeGray		, 1, Arrays.asList(new MaterialStack(Steel, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 1), new TC_AspectStack(TC_Aspects.ORDO, 1), new TC_AspectStack(TC_Aspects.MAGNETO, 1))),
	NeodymiumMagnetic	( 356, Textures.SET_METALLIC			,   7.0F,    512,  2, 1|2          |64|128                  , 100, 100, 100,   0,	"Magnetic Neodymium"			,    0,       0,          0,          0,       1297, 1297,  true, false,   4,  51,  50, Dyes.dyeGray		, 1, Arrays.asList(new MaterialStack(Neodymium, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 1), new TC_AspectStack(TC_Aspects.MAGNETO, 3))),
